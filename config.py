        ...
        if not dictionary:
            ...
            for key in config_dict:
                setattr(
                    ...
                    int(config_dict[key]) if config_dict[key].isnumeric() else config_dict[key]
                )
        else:
            ...
            for key in getattr(self, config_name.replace("-", "_")):
                if getattr(self, config_name.replace("-", "_"))[key].isnumeric():
                    getattr(self, config_name.replace("-", "_"))[key] = int(getattr(self, config_name.replace("-", "_"))[key])
